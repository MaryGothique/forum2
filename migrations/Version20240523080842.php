 ...
 */
final class Version20240523080435 extends AbstractMigration
{
    ...
    {
        // Remove invalid records from the category table
        $this->addSql('DELETE FROM category WHERE created_by_id NOT IN (SELECT id FROM user)');
    ...
    {
        // Remove foreign key constraint from the category table
