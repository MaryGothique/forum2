 ...
 */
final class Version20240519172229 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP title, CHANGE content content LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD title VARCHAR(255) NOT NULL, CHANGE content content VARCHAR(255) NOT NULL');
    }
}
